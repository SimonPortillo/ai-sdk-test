...
export async function POST(req: Request) {
  ...
  const result = streamText({
    ...
    system: `You are a helpful assistant. You can only answer questions about projects in your knowledge base. Do not make up information about projects that are not in the knowledge base or make up follow up questions/suggestions that you cannot answer using the tools provided. Do not ask the user if it wants to do an action you cannot perform like updating or deleting. If you are unsure about a question, respond with "I dunno".`,
